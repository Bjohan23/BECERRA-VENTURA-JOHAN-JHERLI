        ...
        .done((data) => {
            ...
            if (data.ok) {
                $.each(data.body, (index, registro) => {
                    ...
                    t.row.add([botonera, registro.id, registro.nombre, registro.telefono, registro.tipoDocumento, registro.numeroDocumento, registro.direccion, registro.email, registro.numeroDocumento]);
                });
                t.draw(false);
            } else {
